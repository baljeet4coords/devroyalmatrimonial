...
const ProfileCard: React.FC = () => {
    ...
    subDetail:{
        details:["29, 5' 5'", "MBA/PGDM, B.E/B.Tech", "New Delhi", "Analyst", "Chandravanshi Kahar", "Rs. 10 - 15 Lakh per Annum", "Hindi-Delhi", "Never Married"]
    }},
    {details:{
        img: "./Images/profile_image.webp",
        name: "Sweta Singh",
            ...
            <Container className={classes.cardWrapper}>
                    {obj.map((e) => {
                        ...
                        <Col sm={6} className={classes.cardInfo}>
                            ...
                            <ul>
                                {<li key={e.details.id}>{e.subDetail.details}</li>}
                            </ul>
                            <div>
                                <span><TbHistory/></span>
