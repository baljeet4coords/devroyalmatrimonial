    ...
    <Container className={`${classes.cardWrapper}  position-relative`}>
      <Row sm={12} lg={12} className="mb-3">
        <div className={classes.maincard}>
          <Image src={image ? 'https://cdni.iconscout.com/illustration/premium/thumb/cancel-7851800-6267628.png?f=avif' : "./Images/shortlist0.svg"} height={200} alt="done" className="pe-1" />
          <h1>{title}</h1>
          <p>{subtitle}</p>
        </div>
      </Row>
