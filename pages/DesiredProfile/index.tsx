...
const DesiredProfilePage: React.FC = () => {
  ...
  const [searchedMotherTongue, setSearchedMotherTongue] =
    useState<string[]>(CountryList);

  const searchDataFunc = (query: string, idd: string) => {
    if (idd === "country") {
      const searchedCountries = CountryList.filter((country: string) =>
        country.toLowerCase().includes(query.toLowerCase())
      );
      setSearchedCountry(searchedCountries);
    }
    if (idd === "MotherTongue") {
      const searchedMotherTongues = Object.keys(MotherTongue).filter(
        (country: string) => country.toLowerCase().includes(query.toLowerCase())
      );
  ...
  const getClickedData = (data: paramsStatus) => {
    if (
      myMaritalArray.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "Marital"
    ) {
      updateMyMaritalArray((prevArray) => [...prevArray, data.val]);
    }
    if (
      mycountryArray.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "country"
    ) {
      updateMycountryArray((prevArray) => [...prevArray, data.val]);
    }
    if (
      ResidentialArray.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "ResidentialStatus"
    ) {
      updateResidentialArray((prevArray) => [...prevArray, data.val]);
    }
    if (
      ReligionValue.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "Religion"
    ) {
      updateReligionValue((prevArray) => [...prevArray, data.val]);
    }
    if (
      MotherTongueArray.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "MotherTongue"
    ) {
    ...
    if (
      HighestEduArray.indexOf(data.val) === -1 &&
      data.selectedInputQuery === "HighestEdu"
    ) {
            ...
            <Col sm={12} className="d-flex justify-content-center">
              <form className={classes.formEdit}>
                <div className={classes.twoBox}>
                  ...
                  >
                    {`From  ${FromyearValue ? FromyearValue : "24"}`} year{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                            ...
                            <li
                              ...
                              onClick={() =>
                                getClickedData({
                                  val: val,
                                  idd: idd,
                                  selectedInputQuery: "Fromyear",
                                })
                              }
                              className={
                                FromyearValue === val ? classes.tabActive : ""
                              }
                            >
                              <span>{val}</span>
                            </li>
                  ...
                  >
                    {`To ${ToyearValue ? ToyearValue : "24"}`} year{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                            ...
                            <li
                              ...
                              onClick={() =>
                                getClickedData({
                                  val: val,
                                  idd: idd,
                                  selectedInputQuery: "Toyear",
                                })
                              }
                              className={
                                ToyearValue === val ? classes.tabActive : ""
                              }
                            >
                              <span>{val}</span>
                            </li>
                ...
                <div className={classes.twoBox}>
                  ...
                  <div
                    className={classes.inputBox}
                    onClick={() => openList("FromHeight")}
                  >
                    {`From  ${FromyHeightValue ? FromyHeightValue : "6' 2''"}`}{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                        activeList.type === "FromHeight" ? classes.active : ""
                      } ${classes.inputBoxVal}`}
                    >
                      <ul>
                            ...
                            <li
                              ...
                              onClick={() =>
                                getClickedData({
                                  val: val,
                                  idd: idd,
                                  selectedInputQuery: "FromHeight",
                                })
                              }
                              className={
                                FromyHeightValue === val
                                  ? classes.tabActive
                                  : ""
                              }
                            >
                  ...
                  <div
                    className={classes.inputBox}
                    onClick={() => openList("ToHeight")}
                  >
                    {`To  ${ToHeighttValue ? ToHeighttValue : "6' 2''"}`}{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                        activeList.type === "ToHeight" ? classes.active : ""
                      } ${classes.inputBoxVal}`}
                    >
                      <ul>
                            ...
                            <li
                              ...
                              onClick={() =>
                                getClickedData({
                                  val: val,
                                  idd: idd,
                                  selectedInputQuery: "ToHeight",
                                })
                              }
                              className={
                                ToHeighttValue === val ? classes.tabActive : ""
                              }
                            >
                              <span>{val}</span>
                            </li>
                    ...
                    <ul onClick={() => openList("MotherTongue")}>
                            ...
                            <IoClose
                              onClick={() =>
                                getClickedDeleteData({
                                  val: val,
                                  idd: idd,
                                  selectedInputQuery: "MotherTongue",
                                })
                              }
                            />
                          </li>
                      ...
                      <li className={classes.blankInput}>
                        <input
                          type="text"
                          placeholder={
                            MotherTongueArray.length < 1
                              ? "Select Some Options"
                              : ""
                          }
                          onChange={(e) =>
                            searchDataFunc(e.target.value, "MotherTongue")
                          }
                        />
                      </li>
                    </ul>
                        ...
                        {searchedMotherTongue.map((val, idd) => {
                          return (
                            <li
                              ...
                              className={
                                MotherTongueArray.includes(val)
                                  ? classes.tabActive
                                  : ""
                              }
                            >
                    ...
                    <ul onClick={() => openList("Manglik")}>
                      ...
                      <li className={classes.blankInput}>
                        <input
                          type="text"
                          placeholder={
                            ManglikArray.length < 1 ? "Select Some Options" : ""
                          }
                        />
                      </li>
                    </ul>
              ...
              <form className={classes.formEdit}>
                ...
                <div className={classes.twoBox}>
                  ...
                  <div
                    ...
                    onClick={() => openList("Fromyear")}
                  >
                    {`${FromyearValue ? FromyearValue : "Select any"}`}{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                        activeList.type === "Fromyear" ? classes.active : ""
                  ...
                  <div
                    ...
                    onClick={() => openList("Toyear")}
                  >
                    {` ${ToyearValue ? ToyearValue : "Select any"}`}{" "}
                    <SlArrowDown />
                    <div
                      className={`${
                        activeList.type === "Toyear" ? classes.active : ""
