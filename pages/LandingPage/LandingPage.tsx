            ...
            <Container className={`${classes.Home_Page_Wrapper} px-0`}>
                ...
                <Row className={classes.Home_dark_body}>
                    ...
                    <Col sm={12} md={6} className="py-5 pe-5">
                        <div className={`mb-5 me-5 ${classes.scrollBox}`} ref={refTab} onClick={() => refineScroll(0)}>
                        ...
                        <div className={`mb-5 me-5 ${classes.scrollBox}`} onClick={() => refineScroll(476)}>
                            <h3>Royal Matrimonial Match Hour</h3>
                            <p className="me-5">Register to join an online event to connect with members of your community in a short time</p>
                        </div>
                        <div className={`mb-5 me-5 ${classes.scrollBox}`} onClick={() => refineScroll(906)}>
                            <h3>Royal Matrimonial Match Hour</h3>
                            <p className="me-5">Register to join an online event to connect with members of your community in a short time</p>
                        </div>
                    </Col>
                ...
                <Row className={classes.Home_white_body}>
                    <div className={classes.services_box}>
                        <span>PERSONALISED MATCH-MAKING SERVICE</span>
                        <h1>Introducing <strong>Exclusive</strong></h1>
                        <CustomButton onClick={() => console.log("tab")}>Get Started</CustomButton>
                    </div>
